...
│   ├── mermaid.js              # mermaid SVG rendering (static `mermaid` import) + anti-flicker SVG cache + stale-render guard + stylesheet-failure fallback
